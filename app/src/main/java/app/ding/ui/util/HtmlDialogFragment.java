...
public class HtmlDialogFragment extends DialogFragment {
    ...
    private static final String FRAGMENT_TAG = "app.ding.HtmlDialogFragment";
    private static final String ARG_TITLE = "app.ding.HtmlDialogFragment.ARG_TITLE";
    private static final String ARG_RES_HTML_FILE = "app.ding.HtmlDialogFragment.ARG_RES_HTML_FILE";
    private static final String ARG_ACTIONS = "app.ding.HtmlDialogFragment.ARG_ACTIONS";
